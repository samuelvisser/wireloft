...
class DwEpisodeRecord(BaseRecord):
    ...
    # getEpisode exposes this flag while paginated rows may omit it. The API has
    # observed false negatives for records explicitly titled "Official Trailer",
    # so callers must treat it as an affirmative signal rather than a negative veto.
