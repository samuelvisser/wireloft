import ShowForm, {defaultShowFormValue, type ShowFormValue} from '../ShowForm'
...
type Props = {
    ...
    showForm: NewShowFormValue
    setShowForm: (v: NewShowFormValue) => void
    onBack: () => void
    onFinish: () => void
    onCancel: () => void
}

export type NewShowFormValue = ShowFormValue & {
    showUrl: string
        ...
        <div className="form">
            ...
            <div className="form-row">
                ...
                <div>
                    ...
                    <div
                        className="help">{newProfile.preferredFormat} • {newProfile.downloadSeriesImages ? 'Series images ✓' : 'Series images ✕'}</div>
                </div>
            </div>
