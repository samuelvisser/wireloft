...
const SHOW_VARIABLES: readonly OutputTemplateVariable[] = [
    ...
    {name: 'episode_identifier', description: 'Episode identifier without type prefix (e.g. 2497, 2497.1, S01E07)'},
    {name: 'ep_id', description: 'Full WireLoft episode identifier including type prefix'},
