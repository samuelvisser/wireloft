...
const SHOW_VARIABLES: readonly OutputTemplateVariable[] = [
    ...
    {name: 'episode_identifier', description: 'Identifier without type prefix; not guaranteed unique (e.g. 2497, 2497.1, S01E07)'},
    {name: 'episode_key', description: 'Full WireLoft episode key including type prefix; guaranteed unique within the show'},
