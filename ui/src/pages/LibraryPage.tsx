        ...
        <section className="view library-view" aria-labelledby="library-title">
            ...
            {loading && !hasShows && !hasMovies ? (
                ...
                <div className="movie-poster-grid" role="list" aria-label="Movies">
                    {movies!.map((movie) => {
                        // The Library represents WireLoft's persisted state. Use the
                        // artwork saved with the Movie instead of reaching back into
                        // the live Daily Wire catalog, which may expose promotional
                        // artwork and also makes an indexed library network-dependent.
                        const image = toImageUrl(
